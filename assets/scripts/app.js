...
function createTaskButton(tasksItemDescription){
  ...
  registeredTasksItemInput.addEventListener('change', updateCompletedTasksCount);
  ...
  registeredTasksItemDescription.appendChild(document.createTextNode(tasksItemDescription));
  ...
  registeredTasksItem.append(registeredTasksItemInput,registeredTasksItemMark,registeredTasksItemDescription);
